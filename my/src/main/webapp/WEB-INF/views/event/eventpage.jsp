...
<title>Insert title here</title>
 <style>
   ...
   section #content1 ul li:hover,
   section #content1 ul li.on{
      background:#0368DA;
   }
...
<body>
   <section>
      <div>
         <div id="mainimg"> <img src="../resources/event/1spy/event11.jpg" width="1675"> </div>
      </div>
      <div>
         <div id="blueline"> SPY x FAMILY 시크릿 미션 </div>
      </div>
      <p>
      <div id="submenu">
         <a href=""> 유니버설 스튜디오 코리아  > </a> 　
         <a href=""> 이벤트  > </a> 　
         <a href=""> 유니버설 쿨 코리아 2023  > </a> 　
         <a style="color:#00086D;"> SPY x FAMILY 시크릿 미션 </a>
      </div>
      
      <div id="title">
         <span id="left">
            <img src="../resources/event/1spy/event13.jpg" width="280">
         </span> 
         <span id="mid1"> 도전하라! 포저 일가와의 극비 <br> 미션 </span> <br>
         <span id="mid2"> 당신이 직접 스파이가 되어 포저 일가와의 극비 미션에 도전하는, <br> 두근두근 설렘 폭발하는 수수께끼 풀이 랠리&라이브 엔터테인먼트 <br> 쇼가 등장! WISE 첩보원으로 본격적인 스파이 임무에 도전하여 바로 <br> 눈앞에 나타난 로이드, 요르&귀여운 아냐와 함께 참가하는 스릴 만점 <br> 감동적인 엔딩 쇼에 흥분 최고조! 파크에서만 만날 수 있는 리얼한 <br> ‘SPY x FAMILY’의 세계를 즐기자! </span>
         <span id="mid3"> <b>개최기간:</b> <br> 2023년 2월 17일(금)~2023년 7월 2일(일) <br> ※ 개최 기간은 변경될 수 있습니다. </span>
         <span id="smap"> 
            <a href=""> <img src="../resources/event/1spy/event12.jpg" width="380"> </a>
         </span>
      </div>
      ...
      <div id="content1">
         ...
         <div id="p2">
            ...
            <br> ▶ 체험 당사자 1명(만 4세 이상)당 ‘극비 임무 지령서’ 1권을 배포하므로, 반드시 체험할 당사자 전원이 배포 장소로 함께 오십시오.
            <br> ▶ 정원이 차는 대로 배포를 종료합니다.
            <br> ▶ ‘극비 임무 지령서’의 전매, 양도는 금지합니다.
            <br> ▶ 최종 미션(엔딩 쇼)의 시간은 지정할 수 없습니다. 시간 지정이 있는 익스프레스 패스를 소지한 경우나 시간 지정이 있는 이벤트에 참가할 예정이 있는 경우에는 체험할 수 없는 시간대가 있습니다. 양해 바랍니다.
            <br> ▶ 지정 시간에 늦은 경우 또는 해독한 ‘구호’가 오답일 경우에는 최종 미션(엔딩 쇼)에 참가할 수 없습니다.
            <br> ▶ 이벤트는 예고 없이 중지될 수 있습니다.
            <br> ▶ 문서, 구두 전달, SNS 등에 대한 투고, 그 밖의 방법, 형태, 시기, 기간과 관계없이 본 이벤트에 나오는 ‘출제 내용(암호 내용)’ 및 ‘정답(구호)’을 제삼자에게 공개 또는 누설하는 것을 금지합니다. 이와 관련된 공개나 누설 행위가 발견된 경우에는 문서 회수 및 투고 내용의 삭제 등을 요청함과 동시에, 공개나 누설 행위로 인해 발생한 당사의 손해배상을 청구합니다. <p>
         </div>
         <div id="p3">
